<template>
  <div>
    ...
    <n-radio-group v-model:value="value" name="radiogroup" style="width: 100%;">
      <n-space vertical class="hover-space">
        <n-space 
          ...
          class="hover-option"
        >
          <n-radio v-show="active" :value="option.optionId"></n-radio>
          <n-input v-show="active" size="small" v-model:value="option.label" placeholder="请输入选项内容" />
          <n-radio v-show="!active" :value="option.optionId">{{ option.label }}</n-radio>
